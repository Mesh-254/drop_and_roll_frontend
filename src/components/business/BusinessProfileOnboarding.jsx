                ...
                >
                  ...
                  <div className="p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-900/50 rounded-lg">
                    <p className="text-sm text-blue-700 dark:text-blue-300">
                      <strong>NET Terms</strong> allows you to pay later (30, 60, or 90 days) instead of paying upfront after each booking.
                    </p>
                  </div>
                  ...
                  {/* NET terms justification (conditionally shown) */}
