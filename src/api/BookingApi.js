...
export class BookingApi extends ApiBase {
  ...
  async createBooking(bookingData) {
    try {
      const backendData = {
        pickup_address: {
          line1: bookingData.pickupAddress?.line1 || bookingData.pickupAddress?.street || 'Default Pickup Street',
          ...
          country: "GB",
          latitude: bookingData.pickupAddress?.latitude ? Number.parseFloat(bookingData.pickupAddress.latitude) : 123,
